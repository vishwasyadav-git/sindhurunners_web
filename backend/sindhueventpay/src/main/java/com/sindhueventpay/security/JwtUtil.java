...
public class JwtUtil {
    ...
    // Using a default secret for local dev if not provided in properties
    @Value("${jwt.secret:defaultSecretKeyThatIsAtLeast32BytesLongForHS256Algorithm}")
    private String secret;

    @Value("${jwt.expirationMs:86400000}") // 1 day
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        // You can add more claims like role here if needed
